...
which python
/SAN/orengolab/nsp13/.conda/envs/dockstring/bin/python batch_run_dockstring.py --task_index ${SGE_TASK_ID} --smiles_file dude_data/selected_dude/gcr/actives_final.ism --target GCR --active_decoy active
date
